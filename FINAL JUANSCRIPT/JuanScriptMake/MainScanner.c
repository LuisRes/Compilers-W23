...
/* External objects */
extern juan_int line; /* Source code line numbers - defined in scanner.c */
 ...
 * -------------------------------------------------------------
 */
juan_void printScannerError(juan_char* fmt, ...);
juan_void displayScanner(BufferReader* ptrBuffer);
juan_long getScannerFilesize(juan_char* fname);
...
juan_int mainScanner(juan_int argc, juan_char** argv) {
