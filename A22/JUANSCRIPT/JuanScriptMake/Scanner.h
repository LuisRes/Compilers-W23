...
enum TOKENS {
	...
	FPL_T,		/* 12: Float Literal token*/
	OPT_T,		/* 13: Open Tag Token*/
	CLT_T,		/* 14: Closing Tag Token*/
	SEOF_T		/* 15: Source end-of-file token */
};
/* DONE */
...
static juan_int transitionTable[STATE_ROWS][TABLE_COLUMNS] = {
	...
	{	 16,	16,   8	,   5 ,   13,	15,   10,	 1,	 ESNR,	ESWR,  ESNR}, // S0:  NOAS
...
static juan_char* keywordTable[KWT_SIZE] = {
	...
	"ENDJUAN", /*Endif function*/ //8
	"JUAN?" /*Return Tag*/ //9
	"IS" /*Assignment operator*/ //10
};
/* DONE */
